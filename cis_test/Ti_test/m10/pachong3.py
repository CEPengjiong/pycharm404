...
def download(main_url, fileName):
    ...
    try:
        ...
        for item in link:
            i += 1
            minor_url = '花瓣网_陪你做生活的设计师（创意灵感天堂，搜索、发现设计灵感、设计素材）' + item
