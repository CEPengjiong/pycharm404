...
class WebsiteTasks(TaskSet):
    ...
    def chargeDetails(self):
        ...
        url ='/prod-api/clinic/tchargerecord/chargeDetails?_t=' + str(api_congfig._t) + '&pageNum=1&pageSize=10&beginTime=2021-12-02&endTime=2021-12-02'
        res_text = self.client.get(url, name='/tchargerecord/chargeDetails', headers=self.head, verify=False)
        assert '操作成功' in res_text.text, '/tchargerecord/chargeDetails接口获取失败\n结果------------%s' % res_text.text
