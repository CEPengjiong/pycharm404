...
class WebsiteTasks(TaskSet):
    ...
    def countMedicare(self):
        ...
        url ='/prod-api/clinic/medicare/countMedicare?_t=' + str(api_congfig._t)
        res_text = self.client.get(url, name='/medicare/countMedicare', headers=self.head, verify=False)
        assert '操作成功' in res_text.text, '/medicare/countMedicare接口获取失败\n结果------------%s' % res_text.text
