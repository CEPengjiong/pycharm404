...
class WebsiteTasks(TaskSet):
    ...
    def medicineInfo(self):
        ...
        url ='/prod-api/clinic/medicine/info/list?_t=' + str(api_congfig._t) + '&pageNum=1&pageSize=10&enable=1'
        res_text = self.client.get(url, name='/medicine/info/list', headers=self.head, verify=False)
        assert '操作成功' in res_text.text, '/medicine/info/list接口获取失败\n结果------------%s' % res_text.text
