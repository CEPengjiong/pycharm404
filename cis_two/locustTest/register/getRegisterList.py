...
class WebsiteTasks(TaskSet):
    ...
    def getRegisterList(self):
        ...
        url ='/prod-api/clinic/register/getRegisterList?_t=' + str(api_congfig._t) +'&pageNum=1&pageSize=5&beginTime=2021-09-10&endTime=2021-09-20&visitStatus=2'
        res_text = self.client.get(url, name='/register/getRegisterList', headers=self.head, verify=False)
        assert '操作成功' in res_text.text, '/register/getRegisterList接口获取失败\n结果------------%s' % res_text.text
