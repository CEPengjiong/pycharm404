...
class WebsiteTasks(TaskSet):
    ...
    def doctorPerformance(self):
        ...
        url ='/prod-api/clinic/tchargerecord/doctorPerformance?_t=' + str(api_congfig._t) + '&beginTime=2021-10-15&endTime=2021-10-15'
        res_text = self.client.get(url, name='/tchargerecord/doctorPerformance', headers=self.head, verify=False)
        assert '操作成功' in res_text.text, '/tchargerecord/doctorPerformance接口获取失败\n结果------------%s' % res_text.text
